...
class NjConsentForm(ModelForm):
    ...
    class Meta:
        ...
        labels = {
            "authorize_checkbox": """By completing and submitting this form, I confirm that I authorize the collection of specimens necessary to
    conduct COVID-19 testing on me during work hours or in connection with office attendance and work activity.
    I understand that authorizing COVID-19 testing is optional and that I can refuse to give this authorization,
    in which case, I will not be tested. COVID-19 screening testing will be conducted using a pooled PCR testing
    method. Screening testing will be conducted by a contracted vendor or company personnel.
    Any needed confirmatory or “follow-up” testing will be conducted by diagnostic PCR testing of the original specimen.
    TITANIQUE and testing provider, Mirimus, Inc., will maintain a copy of this consent form according to existing state
    and federal records retention laws and will only provide COVID-19 testing to individuals who have a completed consent form on file."""
        }